        ...
        <footer className="text-center text-white bg-[#f1f1f1] ">
            <div className="container mx-auto py-5">
                <div className="flex items-center justify-center">
                    ...
                    <a target='_blank'  rel="noreferrer" href="https://twitter.com/Limitlesss_Ke?s=09" className="mr-9 text-[#23314C]" >
                    ...
                    <a href="https://www.linkedin.com/posts/limitless-security-services-limited_protecting-trademarks-and-brands-should-be-activity-6973240673273561088-PY6q" target='_blank'  rel="noreferrer" className="mr-9 text-[#23314C]">
                        <svg
                        aria-hidden="true"
                        focusable="false"
                        data-prefix="fab"
