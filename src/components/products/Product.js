...
import automaticalarms from '../img/automaticalarms.png'
import ManualAlarms from '../img/ManualAlarms.png'
import panicalarm from '../img/panic alarm.png'
import automaticgate from '../img/AutomaticGate.jpeg'
import biometric from '../img/BiometricaccessSystems.jpeg'
import metaldetector from '../img/Metal Detectors.png'
import vehiclebarrier from '../img/VehicleBarriers.jpeg'
import cctv from '../img/cctv1.jpg'
import firesystem from '../img/Fire Alarm Systems.jpeg'
import smokesystem from '../img/Smoke Screen Systems.png'
import intrudersystem from '../img/Intruder Alarm Systems.png'
import motionSense from '../img/motion.jpeg'
    ...
    <div>
        <div className="py-16 text-[#23314C]">  
            <div className="container m-auto px-6  md:px-12 xl:px-6">
                <h1 className="mb-12 text-center text-3xl text-[#6495ED] font-bold md:text-4xl">Our Security Products</h1>
                ...
                <div className="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
                    <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-[#FFFF] text-center sm:p-8">
                        <div className="h-full flex flex-col justify-center space-y-4">
                            <img className="w-120 h-100 mx-auto" src={automaticalarms} alt="user avatar" height="220" width="220" loading="lazy"/>
                            <h1 className=" text-[#6495ED] text-center md:text-2xl font-bold">Automatic Alarms</h1>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <img className="w-100 h-80 mx-auto" src={ManualAlarms} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Manual Alarms</h1>
                            <p className="text-[#23314C]">A manual alarm system is a basic ‘push and alert’ system. Once the alarm is activated manually by pressing a fixed or wireless remote button, GardaWorld Africa's National Command & Control Centres will receive the alarm activation and dispatch a mobile response team to your home or business immediately.</p>
                            <div>
                                ...
                                <ul className="text-[#23314C] text-md  text-left list-disc list-inside">
                                    <li>Three panic buttons, wired directly to a GardaWorld Africa transmitter</li>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        <img className="w-100 h-40 mx-auto" src={panicalarm} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Panic Alarm Systems</h1>
                    ...
                    <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-[#FFFF] text-center sm:p-8">
                        <div className="h-full flex flex-col justify-center space-y-4">
                            <img className="w-120 h-100 mx-auto" src={intrudersystem} alt="user avatar" height="220" width="220" loading="lazy"/>
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Intruder Alarm Systems</h1>
                            <p className="text-[#23314C]">
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <img className="w-100 h-60 mx-auto" src={smokesystem} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Smoke Screen Systems</h1>
                            <p className="text-[#23314C]">
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        <img className="w-100 h-40 mx-auto" src={firesystem} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Fire Alarm Systems</h1>
                ...
                <div className="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
                    <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-[#FFFF] text-center sm:p-8">
                        <div className="h-full flex flex-col justify-center space-y-4">
                            <img className="w-120 h-100 mx-auto" src={cctv} alt="user avatar" height="220" width="220" loading="lazy"/>
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">CCTV Monitoring Systems</h1>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <img className="w-150 h-40 mx-auto" src={vehiclebarrier} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Vehicle Barriers</h1>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        <img className="w-100 h-40 mx-auto" src={automaticgate} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Automatic Gate</h1>
                            <p className="text-[#23314C]">
                    ...
                    <div className="row-span-2 p-6 border border-gray-100 rounded-xl bg-[#FFFF] text-center sm:p-8">
                        <div className="h-full flex flex-col justify-center space-y-4">
                            <img className="w-160 h-160 mx-auto" src={biometric} alt="user avatar" height="220" width="220" loading="lazy"/>
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Biometric Access Systems</h1>
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <img className="w-100 h-60 mx-auto" src={metaldetector} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Metal Detectors</h1>
                            <p className="text-[#23314C]">
                    ...
                    <div className="p-6 border border-gray-100 rounded-xl bg-[#FFFF] sm:flex sm:space-x-8 sm:p-8">
                        ...
                        <img className="w-60 h-25 mx-auto" src={motionSense} alt="user avatar" height="220" width="220" loading="lazy"/>
                        <div className="space-y-4 mt-4 text-center sm:mt-0 sm:text-left">
                            <h1 className="text-[#6495ED] text-center md:text-2xl font-bold">Motion Senses</h1>
                            <p className="text-[#23314C]">
                            These walk-through detectors allow a high level of differentiation between significant metal masses, such as weapons and personal metal effects.
                            </p>
                            <div>
                ...
                <p className="text-center">
                    ...
                    <br />
                    <a href='f' className="text-[#6495ED]">
                        contact us today.
                    </a>
